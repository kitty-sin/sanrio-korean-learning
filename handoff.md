...
5. [x] **☁️ Firebase 雲端自學單字庫**（自訂新增單字、即時同步、語音跟讀與拼音拆解）
6. [x] **🍲 10 頁 Sanrio 主題 100 常見食物發音學習手札**（`sanrio_korean_food_100.html`，含 0.3x 逐字慢速口型）
7. [x] **📚 韓語核心高頻 5,666 詞彙全量結構化資料庫**（各期 CSV/MD 與終極總表 `korean_vocab_5666.csv/md`）
8. [x] **📄 20 頁超大字 Sanrio 拼音總表 PDF 與 HTML 母檔**

---

## 🚦 5. 目前狀態與下一步 (Status & Roadmap)

- **🚦 目前狀態**：已完成 7 大收音粵語口訣（呃/壓/鴨/硬/眼/岩）在積木屋、教學卡與拆解彈窗中的深度整合，並已同步推播更新至 GitHub Pages。
- **➡️ 下一步**：
