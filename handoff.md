...
- **2026-09-11 15:42 PT**：
  - 依使用者要求，將字典頁面標題中的「Sanrio」字樣移除，正式更名為「**韓語 5,666 核心詞庫大字典**」。
  - 全面修正原始資料庫與網站中的詞性誤植：將 `#5635 미국 (美國)` 與 `#5655 제주도 (濟州島)` 由「動詞」更正為「**專有名詞 (地名/國名)**」及 **D 級**。
  - 同步更新檔案：`korean_vocab_5666.csv`、`korean_vocab_5666.md`、`korean_vocab_5666_data.js` 及 `korean_vocab_dictionary.html`，並推播至 GitHub Pages。
- **➡️ 下一步**：
