...
1. **🧩 雙收音 (겹받침) 核心代表詞彙庫擴充與查重盤點**：
   ...
   - 全量同步 `korean_vocab_kitty_add_data.js`、`korean_vocab_kitty_add.csv`、`korean_vocab_kitty_add.md`，Kitty 自訂庫累計達 **36 筆**，全庫總量達到 **5,702 筆**；單音節矩陣重構維持 **1,044 組**。
