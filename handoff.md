...
- **2026-09-18 23:13 PT**：
  - **📖 全站頂部導航站 PDF 按鈕文案統一更名為「發音教學PDF(20頁)」**：
    - 依使用者指示，將全站頂部導航站中的 `[20頁PDF簡報]` / `[20頁PDF]` / `[20頁PDF講義]` 按鈕文案統一調整為 **`[發音教學PDF(20頁)]`**（`index.html`、`korean_vocab_dictionary.html`、`korean_hanja_dictionary.html`）。
    - `sw.js` 升級至 `v1.0.30`，同步鏡像至 `www/`，推播至 GitHub Pages。
- **➡️ 下一步**：
