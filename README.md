...
- **🐱 6 大基礎母音字卡**：結合 Hello Kitty、布甸狗、美樂蒂、玉桂狗、Kuromi、雙子星視覺聯想及廣東話口訣。
- **🐶 基礎子音積木**：聲母快速記憶。
- **🧩 拼音積木屋**：實時聲母＋韻母組合，動態計算 Unicode 韓文字母並支援點擊發音。
- **☁️ Firebase 雲端自學單字庫**：即時同步儲存至 Firestore，全體學員共享字庫。
- **⭐ Sanrio 星級挑戰測驗**：5 題隨堂測驗評量學習成效。
- **🏆 Firebase 即時榮譽榜**：測驗完成上傳成績，全體學員即時排行榜。
- **💖 即時集氣加油**：一鍵為全體學習夥伴加油打氣。
