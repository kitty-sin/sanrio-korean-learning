...
├── korean_hanja_data.js         # 6,519 筆漢字詞與 1,037 音節常數數據集
...
├── korean_vocab_kitty_add_data.js # Kitty 自訂新增詞庫常數數據集 (#5667 起)
├── korean_vocab_kitty_add.csv   # Kitty 自訂新增詞庫 CSV 總表
├── korean_vocab_kitty_add.md    # Kitty 自訂新增詞庫 Markdown 字典
