...
├── korean_vocab_kitty_add_data.js # Kitty 自訂新增詞庫常數數據集 (#5667 ~ #5738)
├── korean_vocab_kitty_add.csv   # Kitty 自訂新增詞庫 CSV 總表 (72 筆)
├── korean_vocab_kitty_add.md    # Kitty 自訂新增詞庫 Markdown 字典 (72 筆)
...
├── sw.js                        # Service Worker 離線快取核心 (v1.0.45)
