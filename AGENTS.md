...
- [x] **🚂 KITTY 韓語造句積木列車** (`sanrio_korean_sentences.html`，暖杏原木手繪列車風 ✕ 酷企鵝車長 🐧，車卡 1 主語、車卡 2 受語、車卡 3 動詞自由輸入與快捷詞卡點選，全自動生成詞典原形、現在式一般/進行、過去式、未來式、否定疑問句、0.3x/0.7x/1.0x 三段速語音與隨堂星級闖關測驗)
