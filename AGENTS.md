...
├── korean_vocab_kitty_add_data.js # Kitty 自訂新增詞庫常數數據集 (#5667 ~ #5702)
├── korean_vocab_kitty_add.csv   # Kitty 自訂新增詞庫 CSV 總表 (36 筆)
├── korean_vocab_kitty_add.md    # Kitty 自訂新增詞庫 Markdown 字典 (36 筆)
